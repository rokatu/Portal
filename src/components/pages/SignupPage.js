...
import {getSimplecircSubscriptionUrl, isPrintPlan, isFreePlan, getFreeTierTitle, getSiteProducts, getSitePrices, hasOnlyFreePlan, isInviteOnlySite, freeHasBenefitsOrDescription, hasOnlyFreeProduct, getFreeProductBenefits, getFreeTierDescription, hasFreeProductPrice, hasMultipleNewsletters} from '../../utils/helpers';
...
class SignupPage extends React.Component {
    ...
    handleChooseSignup(e, plan) {
        e.preventDefault();
        const isPrint = isPrintPlan({planId: plan, site: this.context.site});
        this.setState((state) => {
            if (isPrint) {
                return;
            }
